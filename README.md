# TP Semanal: Portal de Noticias Propio (Mobile First + Flexbox)
...
* **Flexbox Layout:** Implementación de contenedores flexibles dinámicos para columnas y grillas de noticias.
* **Estructura Separada:** Uso de `normalize.css` externo y hoja de estilos personalizada en directorio `/css`.